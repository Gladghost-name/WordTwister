...
if selected == "Finder":
    ...
    st.write("🪢 Word Twister finds anagrams of any given word,by generating anagrams of that word with varied lengths.The threshold parameter signifies the accuracy of words that are used as anagrams.I recommend that you use a threshold of .5 and above.")
    ...
    with st.expander("Show/Hide Extra Options"):
        ...
        vocabulary = st.selectbox("Select Vocabulary", options=["📙 300k English Words", "📙 200k English Words", "📙 100k French Words"])
